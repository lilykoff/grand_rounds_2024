...
![<https://xkcd.com/1478/>](figs/p_values.png)
...
![Farber, *N Egnl J Med*, 2022](figs/rct.png)
:::

::: {.column width="50%"}

+ Enroll individuals randomize to treatment or control group 
+ Follow over time and assess outcome
+ If possible, use placebo for control group; blind participants and clinicians 
  + Incidence of major adverse event or death lower in surgical group among patients with "adequate great saphenous vein for surgical revascularization" (cohort 1)
  + In cohort two, outcomes were similar 
...
::: {.column width="50%"}
![Outcomes of Vascular and Endovascular Interventions Performed During the Coronavirus Disease 2019 (COVID-19) Pandemic, Benson, *Ann Surg*, 2021](figs/pro2.png)
:::
...
+ Enroll individuals free of outcome, follow and assess outcome 
  ...
  + Assess mortality
  + Control for confounding with multivariate logistic regression
  + COPD, lower respiratory infections positively associated with mortality, elective caes, use of oral anticoagulants and antiplatelets associated with lower mortality
...
Aneurysm in the Medicare Population, Schemerhorn, *N Engl J Med*, 2015](figs/retro.png){width="88%" fig-align="left"}
:::
...
+ Population of interest is identified, exposure status is retroactively determined
  ...
  + Control for confounding with propensity score matching 
  + Higher survival but higher rates of late rupture in endovascular repair compared to open repair
...
## Comparison: confounding {.smaller}

+ RCTs
    + Randomization ensures prognosis or disease severity don't influence treatment 
    + Confounding variables are balanced (on average) between groups
+ Cohort studies
...
## Comparison: validity {.smaller}

+ RCTs
    + Internally valid, but may not generalize if target population $\neq$ study population
    + Often the case due to strict inclusion criteria ("Patients were excluded from the trial if they had excessive risk associated with open vascular surgery")
+ Cohort studies
...
+ Both RCTs and cohort studies: 
  ...
  + Depending on relationship between LTFU (compliance), exposure, outcome can lead to loss of power or bias 
+ Strategies to minimize/address
  + Study design
...
+ Both RCTs and cohort studies:
  ...
  + Conditioning on hospitalization (i.e. association between peripheral vascular disease and  orthopedic injuries)
  + Women excluded from PAD research^[Vavra, *Women's Health (Lond)*, 2009]
...
::: {.column width="50%"}
![Katsanos, *J Am Heart*, 2018](figs/pcb1.png)
::: 


::: {.column width="50%"}
![Risk of all-cause death at $\color{red}{1.68}$ times higher in PCD group at 2 years and $\color{red}{1.93}$ times higher at 5 years](figs/pcb2.png)
::: 
...
+ Retrospective analysis of insurance claims matched patients^[Behrendt, *Eur J Vasc Endovasc Surg*, 2020]
    + PCDs associated with increased long term survival, lower amputation rates, lower cardiovascular events 
+ Retrospective analysis of Medicare data^[Long, *Am Heart J*, 2019]
    + PCDs associated with better survival at 2 years, clinical outcomes at 1 year 
 Internal external validity tradeoff 
